...
const PageEight = () => {
  return (
    <div className=" h-screen md:h-[165vh]"  data-aos="fade-up"data-aos-once="false">
    ...
    <div className="text-left lg:-translate-y-1/2 translate-y-1/2 absolute top-[50%] hover:scale-110 transition-all duration-500 max-lg:justify-center lg:left-8 max-lg:p-16"><Image className='md:h-[80vh] w-auto ' src={Car} width={500} height={800}/></div>
