...
const PageEight = () => {
  return (
    <div className=" h-full lg:h-[165%]" >
        <div className='bg-black absolute h-[80vh] -z-10 screen w-full object-cover'/>
    <Image className=" h-[80vh] p8  max-lg:absolute object-cover  opacity-90" src={Cover} width={3841} height={2159}/>
